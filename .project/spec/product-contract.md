...
- Raw source events are short-lived and retained only for a bounded hot window, initially targeted at about 7 days.
...
- A temporary Postgres-backed read model may be used for demo projections as long as the filesystem-backed PoC substrate remains the write-path source of truth.
